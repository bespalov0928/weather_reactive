package com.example.weather_reactive.controller;

import com.example.weather_reactive.model.Weather;
import com.example.weather_reactive.service.WeatherService;
...
public class WeatherControl {
   ...
   @GetMapping(value = "/hottest")
    public Flux<Weather> findHostsCity(){
        return weathers.findHostsCity();
   }

   @GetMapping(value = "/cityGreatThen/{temp}")
    public Flux<Weather> findCityMoreTemp(@PathVariable Integer temp){
        return weathers.findCityMoreTemp(temp);
   }
